import { ArrowLeftRight, Hourglass, Lock, Radar, ShieldCheck, SquareTerminal, Trash2, Waypoints } from "lucide-react";
...
export const SOON: AppManifest[] = [
  ...
  soon({ id: "swap", name: "Swap", blurb: "USDC, EURC and cirBTC", icon: ArrowLeftRight, category: "trade", release: "r0" }),
